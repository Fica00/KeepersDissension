...
public class PreviewFactionPanel : MonoBehaviour
{
    ...
    public void Setup(FactionSO _faction)
    {
        ...
        foreach (var _card in _cards)
        {
            ...
            else if (_card is Marker)
            {
                if (_lookingForMarker)
                {
                    _lookingForMarker = false;
                }
                else
                {
                    continue;
